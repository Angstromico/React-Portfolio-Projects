...
![Screenshop](https://raw.githubusercontent.com/Angstromico/React-Portfolio-Projects/master/logo.png)

# [See The App Here](https://manuel-morales-react-projects.netlify.app/)

# This Part Belows to the creator of the original repository
...
// package.json
{
  ...
  "homepage": `https://angstromico.github.io/profolio-react-projects/`,   <-- remove/edit this
  "version": "0.1.0",
  "private": true,
  "dependencies": {
  ...
